 ...
 * com.javax.xml.stream.notations and com.javax.xml.stream.entities.
 * When the current event is a DTD the following call will return a
 * list of Notations
 *  <code>List l = (List) getProperty("com.javax.xml.stream.notations");</code>
 * The following call will return a list of entity declarations:
 * <code>List l = (List) getProperty("com.javax.xml.stream.entities");</code>
 ...
 * @see com.javax.xml.stream.events.XMLEvent
 * @see XMLInputFactory
 * @see XMLStreamWriter
 */
public interface XMLStreamReader extends XMLStreamConstants {
   ...
   * If the property com.javax.xml.stream.isCoalescing is set to true
   ...
   * Regardless of value of com.javax.xml.stream.isCoalescing this method always returns coalesced content.
